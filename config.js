...
const defaultOwner = '254114148625';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '254114148625' ; // put your number here
...
//
global.botname = process.env.BOTNAME || 'KANAMBO-AI';
